  ...
  return (
    <div className="mx-auto max-w-3xl text-center">
      ...
      <p className="mt-5 text-muted-foreground">
        Everything you'd expect from a premium hotel — quietly built into every apartment.
      </p>
    </div>
  );
}
  ...
  return (
    <section id="amenities" className="bg-background py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6">
        <SectionEyebrow label="In-Residence" title={<>Luxury <span className="italic text-gold">Amenities</span></>} />
        <motion.div
